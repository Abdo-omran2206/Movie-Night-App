...
### Goals
- **Discovery-first experience**: help users quickly find something to watch (trending + categories).
- **Deep exploration**: rich details pages for movies, TV, and actors (cast, similar/recommendations, photos).
...
- Full streaming provider integration (where to watch) and subscription management.
